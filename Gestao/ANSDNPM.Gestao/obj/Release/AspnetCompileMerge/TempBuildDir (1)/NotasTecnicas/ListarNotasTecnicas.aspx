                                ...
                                <asp:Repeater ID="rptNotasTecnicas" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><a href="AlterarNotaTecnica.aspx?idNtt=<%#Eval("IDNotaTecnica")%>" data-toggle="tooltip" data-placement="top" title="Alterar Nota Técnica"><span class="glyphicon glyphicon-pencil" style="margin-right:10px"></span></a><a href="#" onclick="return confirmaExclusao(this, <%#Eval("IDNotaTecnica")%>);" data-toggle="tooltip" data-placement="top" title="Excluir Nota Técnica"><span class="glyphicon glyphicon-trash"></span></a></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
						    </tbody>
