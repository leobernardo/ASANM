<%@ Page Title="[GESTÃO] ANSDNPM - Associação Nacional dos Servidores do DNPM" Language="C#" MasterPageFile="~/MasterPages/mpASANM.Master" AutoEventWireup="true" CodeBehind="ListarNoticias.aspx.cs" Inherits="ASANM.Gestao.Noticias.ListarNoticias" %>
  					    ...
  					    <table class="table table-striped table-bordered" id="dataTable">
						    ...
						    <tbody>
                                <asp:Repeater ID="rptNoticias" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%#getImagem(Convert.ToInt32(Eval("IDNoticia")))%></td>
                                            <td><%#Eval("DSTitulo")%></td>
