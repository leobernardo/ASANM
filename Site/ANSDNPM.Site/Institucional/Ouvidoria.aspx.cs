...
namespace ASANM.Site.Institucional
{
    public partial class Ouvidoria : System.Web.UI.Page
    {
        ...
        protected void Enviar(object sender, EventArgs e)
        {
            ...
            string emailDestinatario = "ouvidoria@ansdnpm.org.br";
            //string emailComCopia = "leonardo.bernardo@dnpm.gov.br";
            //string emailComCopiaOculta = "email@comcopiaoculta.com.br";

            string assuntoMensagem = "[Ouvidoria] - Novo e-mail enviado através do site da ANSDNPM";
            ...
            try
            {
                ...
                Response.Write("<script language='JavaScript'>alert('Sua mensagem foi enviada com sucesso');window.location='Ouvidoria.aspx';</script>");
            }
            catch (Exception ex)
            {
